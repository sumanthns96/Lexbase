...
import { Mic, MicOff, MessageCircle, X, Globe } from "lucide-react";
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-16 w-16 items-center justify-center rounded-full bg-primary shadow-lg transition-colors hover:bg-gold-dim"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        animate={isConnected ? { boxShadow: ["0 0 20px hsl(43 90% 55% / 0.3)", "0 0 40px hsl(43 90% 55% / 0.5)", "0 0 20px hsl(43 90% 55% / 0.3)"] } : {}}
